...
const savedTheme = localStorage.getItem("ig-wa-outreach-crm.theme") || "dark";
...
function injectNavigation(activePage) {
  ...
  headerContainer.innerHTML = `
    <header class="app-header">
      ...
      <div class="topbar-actions">
        ...
        <button id="theme-toggle" class="theme-toggle-btn" aria-label="Ganti tema" type="button">
          <!-- Sun Icon (shows in dark mode -> switches to light) -->
          <svg class="sun-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.72" x2="5.64" y2="18.3"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
          <!-- Moon Icon (shows in light mode -> switches to dark) -->
          <svg class="moon-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
        </button>
      </div>
    </header>
  `;
  ...
  if (themeToggle) {
    themeToggle.addEventListener("click", () => {
      ...
      localStorage.setItem("ig-wa-outreach-crm.theme", newTheme);
    });
  }
